...
(function (factory) {
  ...
  ko.bindingHandlers.hueIcon = {
    iconRepo: function (name) {
      switch (name) {
        case 'impala':
          return $('<svg aria-hidden="true" style="fill: #aaa; height: 54px" role="img" viewBox="0 0 16 16"><path d="M9.5,0A6.22,6.22,0,0,1,11.26,3.2a6.6,6.6,0,0,1,0,2.6,0.32,0.32,0,0,1-.15.19A6,6,0,0,0,9.73,7.7a4.38,4.38,0,0,0-.27.93,0.32,0.32,0,0,0,.11.28,0.38,0.38,0,0,0,.32-0.08A9,9,0,0,0,10.63,8c0.27-.34.46-0.69,0.87-1.23a2.54,2.54,0,0,1-.84,2.5,1.15,1.15,0,0,0-.27.24,0.66,0.66,0,0,0,.1,1.17,0.7,0.7,0,0,1-.23.12,0.47,0.47,0,0,0-.17.33,0.59,0.59,0,0,0-.22.33,11.36,11.36,0,0,1-.71,3.72,1.33,1.33,0,0,1-.91.78,0.64,0.64,0,0,0,0-.5,1.94,1.94,0,0,1-.56-0.19,0.3,0.3,0,0,1,.21,0,0.29,0.29,0,0,0,.36-0.21A0.41,0.41,0,0,0,8,14.63a0.41,0.41,0,0,1-.32-0.46,1.11,1.11,0,0,1,.39.32c0.22,0.23.33,0,.45-0.16a0.32,0.32,0,0,0,.15-0.17c0-.15,0-0.3-0.06-0.51A3.29,3.29,0,0,1,9.13,11a1,1,0,0,0,.05-1.16C9.12,9.72,9.07,9.61,9,9.51a2.1,2.1,0,0,1-.06-2.28,6.41,6.41,0,0,1,1.45-1.86,3.18,3.18,0,0,0,.18-1A6.34,6.34,0,0,0,9.5,0Z"/><path d="M6.66,0A6,6,0,0,0,5.59,3.05a7.92,7.92,0,0,0,.14,2.16,0.6,0.6,0,0,0,.17.25,6.08,6.08,0,0,1,1.43,2.1,3,3,0,0,1,.16.8,0.82,0.82,0,0,1-.82.87c0-.22,0-0.62-0.07-0.84A4.9,4.9,0,0,0,5,5.88a1.32,1.32,0,0,1-.18-0.69A6.21,6.21,0,0,1,6.66,0Z"/><path d="M6.14,10.76a0.66,0.66,0,0,1,1,.19,5.23,5.23,0,0,1,.4,1.7c-0.12-.29-0.37-0.95-0.48-1.23s-0.16-.08-0.33-0.11a0.64,0.64,0,0,1-.27-0.45A0.63,0.63,0,0,0,6.14,10.76Z"/><path d="M6.1,9.37a2.44,2.44,0,0,1-1.26-1.9A5.43,5.43,0,0,1,6.1,9.37Z"/></svg>');
      }
    },

    update: function (element, valueAccessor) {
      var iconName = ko.utils.unwrapObservable(valueAccessor());
      ko.virtualElements.emptyNode(element);
      ko.virtualElements.prepend(element, ko.bindingHandlers.hueIcon.iconRepo(iconName)[0]);
    }
  };
  ko.virtualElements.allowedBindings.hueIcon = true;

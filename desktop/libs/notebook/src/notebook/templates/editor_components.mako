...
<script type="text/html" id="snippet-settings-toggle">
  <div style="margin-top:70px;" data-bind="attr: { 'id': 'toggleResultSettingsGrid' + id() }, click: toggleResultSettings" class="hover-actions toggle-result-settings show-result-settings">
